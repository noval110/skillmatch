...
export const getTeamConversation = (
  teamId,
) =>
  request(
...
export const getShowcase = () =>
  request('/profile/showcase')

export const saveShowcaseItem = (
  kind,
  id,
  body,
) =>
...
export const getTeamMilestones = (
  teamId,
) =>
  request(
...
export const createTeamMilestone = (
  teamId,
  body,
) =>
  request(
...
export const updateTeamMilestone = (
  teamId,
  milestoneId,
  body,
) =>
...
export const deleteTeamMilestone = (
  teamId,
  milestoneId,
) =>
  request(
...
export const getRecommendedTeams =
  () =>
    request(
      '/teams/recommended',
    )
...
export const getRoleSkills = (
  ...
  request(
    `/teams/${teamId}/roles/${roleId}/skills`,
    {
      auth: false,
    },
  )

export const addRoleSkill = (
  teamId,
  roleId,
  body,
) =>
...
export const deleteRoleSkill = (
  teamId,
  roleId,
  skillId,
) =>
  request(
    `/teams/${teamId}/roles/${roleId}/skills/${skillId}`,
    {
      method: 'DELETE',
    },
  )

export const getRoleMatch = (
  teamId,
  roleId,
) =>
  request(
    `/teams/${teamId}/roles/${roleId}/match`,
  )
